...
class GameServiceAdditionalTests {
    ...
    void checkIfGameIsInDatabase_addsGameWhenRawgReturnsMatch() {
        ...
        // stub mapper consolidation static behavior via spy on GameDataMappers is not needed; method is static
    ...
    void checkIfGameIsInDatabase_throwsWhenRawgReturnsMatchWithoutId() {
        ...
        assertThrows(RuntimeException.class, () -> gameService.checkIfGameIsInDatabase("NoId"));
    }
    ...
    void checkIfGameIsInDatabase_throwsWhenGetGameDetailsReturnsNull() {
        ...
        assertThrows(RuntimeException.class, () -> gameService.checkIfGameIsInDatabase("MissingDetails"));
    }
    ...
    void searchGameByDeveloper_savesMissingGamesToRepository() {
        ...
        when(mapper.ConvertRawgResponseToGamesModel(response)).thenReturn(List.of(new com.example.backloggd.DTO.GameSummaryDTO(21, "NewOne", "2020", 70, "", "", "desc", "dev", "pub", "", 0.0)));
    ...
    void searchGameByDeveloper_doesNotSaveWhenGameAlreadyExists() {
        ...
        when(mapper.ConvertRawgResponseToGamesModel(response)).thenReturn(List.of(new com.example.backloggd.DTO.GameSummaryDTO(22, "Exists", "2020", 70, "", "", "desc", "dev", "pub", "", 0.0)));
